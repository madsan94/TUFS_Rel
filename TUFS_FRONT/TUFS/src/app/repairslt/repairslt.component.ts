...
@Component({
  ...
  templateUrl: './repairslt.component.html',
  styleUrls: ['./repairslt.component.css']
})
export class LtRepairComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder, public snackBar: MatSnackBar, public gadgetservice: GadgetsService,private route:ActivatedRoute,private router:Router) { }
